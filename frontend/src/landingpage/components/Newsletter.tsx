  ...
  const benefits = [
    {
      ...
      description: "Weekly analysis of market trends and investment opportunities"
    },
    {
      icon: DollarSign,
      title: "Money Tips",
    ...
    },
    {
      ...
      description: "Important security notifications and feature announcements"
    }
  ];
    ...
    <section className="py-20 bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8">
              ...
              packed with market insights, money-saving tips, and exclusive offers.
            </p>
                ...
                {!isSubscribed ? (
                  <>
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600">Get weekly insights delivered to your inbox</p>
                    </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-600 mb-4">Trusted by customers at leading companies</p>
          <div className="flex items-center justify-center space-x-8 opacity-40">
            <div className="font-bold text-gray-700">Google</div>
            <div className="font-bold text-gray-700">Microsoft</div>
            <div className="font-bold text-gray-700">Apple</div>
            <div className="font-bold text-gray-700">Amazon</div>
            <div className="font-bold text-gray-700">Tesla</div>
          </div>
        </div>
      </div>
    </section>
